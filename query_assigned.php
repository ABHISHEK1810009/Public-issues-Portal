            ...
            <table id="dataTable1" width="100%" class="table table-lightfont small">
                ...
                <tbody>
                    ...
                    <tr id="ro<?php echo $query->id; ?>">
                        ...
                        <td><?php echo date('d-m-Y h:i A', strtotime($query->assigned_at)); ?></td>
                        <td><?php echo $query->assign_to_name; ?></td>
                        <td><?php echo $query->assign_by_name; ?></td>
                        <td>
