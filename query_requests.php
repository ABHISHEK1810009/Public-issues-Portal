<div class="element-wrapper">
    <div class="element-header">
        <h3 class="mb-0">Query Requests</h3>
    </div>
            ...
            <table id="dataTable1" width="100%" class="table table-lightfont small">
                ...
                <tbody>
                    ...
                    <tr id="ro<?php echo $query->id; ?>">
                        ...
                        <td><?php echo date('d-m-Y h:i A', strtotime($query->created)); ?></td>
                        <td width="100">
                            <a href="<?php echo base_url(); ?>admin/query/<?php echo $query->id; ?>" class="btn btn-sm btn-primary">
                                <i class="fa fa-tasks text-white"></i>
                            </a>
                            <a onclick="delete_query('<?php echo $query->id; ?>')" class="btn btn-sm btn-danger">
